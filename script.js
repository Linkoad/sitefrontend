...
function animateOnScroll() {
    const elements = document.querySelectorAll('.feature-card, .pricing-card, .stat');
...
console.log('%c🎓 Bem-vindo ao Esquemaria!', 'color: #1E90FF; font-size: 20px; font-weight: bold;');
console.log('%cEste site foi desenvolvido com HTML5, CSS3 e JavaScript vanilla.', 'color: #666; font-size: 14px;');
